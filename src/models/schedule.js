...
class Course {
    ...
    createOne(
        ...
        if (invalidPrerequisite?.length > 0)
            return callback(
                throwError({ name: "InvalidObjectID", message: "Prerequisite has an invalid ObjectId.", status: 200 }),
                null
            );
        ...
        if (
            ...
            return callback(
                throwError({ name: "SyntaxError", message: "Properties of timeAllocation is invalid.", status: 200 }),
                null
            );
